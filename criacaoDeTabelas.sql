...
CREATE TABLE Eleicao (Titulo varchar2(50) NOT NULL, Descricao varchar2(255) NOT NULL, DataIncio date NOT NULL, DataFim date NOT NULL, VotosNulos number(10) NOT NULL, VotosBranco number(10) NOT NULL, Abstencoes number(10) NOT NULL, tipo varchar2(255) NOT NULL, ID number(10) NOT NULL, UnidadeOrganicaNome varchar2(100) NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE Mesa_Voto_Pessoa (Mesa_VotoUONome varchar2(100) NOT NULL, Mesa_VotoID number(10) NOT NULL, PessoaNumCC number(8) NOT NULL, PessoaUnidadeOrganicaNome varchar2(100) NOT NULL, votarOuAssociar number(1) NOT NULL, dataVoto date, PRIMARY KEY (Mesa_VotoUONome, Mesa_VotoID, PessoaNumCC, PessoaUnidadeOrganicaNome));
