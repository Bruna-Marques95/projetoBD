...
CREATE TABLE Eleicao (Titulo varchar2(50) NOT NULL, Descricao varchar2(255) NOT NULL, DataInicio TIMESTAMP NOT NULL, DataFim TIMESTAMP NOT NULL, VotosNulos number(10) NOT NULL, VotosBranco number(10) NOT NULL, Abstencoes number(10) NOT NULL, tipo varchar2(255) NOT NULL, ID number(10) NOT NULL, UnidadeOrganicaNome varchar2(100) NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE Mesa_Voto_Pessoa (Mesa_VotoUONome varchar2(100) NOT NULL, Mesa_VotoID number(10) NOT NULL, PessoaNumCC number(8) NOT NULL, PessoaUnidadeOrganicaNome varchar2(100) NOT NULL, votarOuAssociar number(1) NOT NULL, dataVoto TIMESTAMP, PRIMARY KEY (Mesa_VotoUONome, Mesa_VotoID, PessoaNumCC, PessoaUnidadeOrganicaNome));
...
CREATE TABLE Pessoa (Nome varchar2(255) NOT NULL, NomeUtilizador varchar2(255) NOT NULL UNIQUE, Password varchar2(255) NOT NULL, NumTelefone number(9) NOT NULL, Morada varchar2(255) NOT NULL, ValidadeCC date NOT NULL, NumCC number(8) NOT NULL UNIQUE, UnidadeOrganicaNome varchar2(100) NOT NULL, tipo varchar2(50) NOT NULL, PRIMARY KEY (NumCC, UnidadeOrganicaNome));
